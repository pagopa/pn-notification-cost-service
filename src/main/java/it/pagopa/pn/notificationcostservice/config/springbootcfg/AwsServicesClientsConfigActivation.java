...
public class AwsServicesClientsConfigActivation extends AwsServicesClientsConfig {
    ...
    public DynamoDbEnhancedAsyncClient dynamoDbEnhancedAsyncClientWithMDC(DynamoDbAsyncClient delegate) {
        return new DynamoDbEnhancedAsyncClientDecorator(this.buildDynamoDbEnhancedAsyncClient(delegate));
    }

    private DynamoDbEnhancedAsyncClient buildDynamoDbEnhancedAsyncClient(DynamoDbAsyncClient baseAsyncClient) {
